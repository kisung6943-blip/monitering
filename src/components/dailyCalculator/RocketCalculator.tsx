...
import { DEFAULT_SETTINGS, INITIAL_COST_ITEMS, INITIAL_ORDERS } from '../../dailyCalculatorData/initialData';
...
export const RocketCalculator: React.FC = () => {
  ...
  return (
    <div className="bg-slate-100/70 rounded-2xl border border-slate-200 shadow-sm p-3 my-8 font-sans text-slate-900 antialiased selection:bg-indigo-100 selection:text-indigo-900">
      {/* Header */}
      <Header
      ...
      {/* Footer */}
      <footer className="bg-white rounded-xl border border-slate-200 py-3 px-4 mt-4 text-center text-xs text-slate-500">
        <p>
          쇼핑몰 판매자 전용 일일 정산 계산기 (스마트스토어, 쿠팡, 오늘의집, 자사몰, 11번가, G마켓, 옥션 지원)
        </p>
      </footer>
