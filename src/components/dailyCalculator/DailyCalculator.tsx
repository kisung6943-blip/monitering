...
export const DailyCalculator: React.FC = () => {
  ...
  return (
    <div className="bg-slate-100/70 rounded-2xl border border-slate-200 shadow-sm p-3 my-4 font-sans text-slate-900 antialiased selection:bg-indigo-100 selection:text-indigo-900">
      {/* Header */}
      <Header
